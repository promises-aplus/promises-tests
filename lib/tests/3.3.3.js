...
describe("3.3.3: Otherwise, if `x` is an object or function,", function () {
    describe("3.3.3.1: Let `then` be `x.then`", function () {
    ...
    describe("3.3.3.2: If retrieving the property `x.then` results in a thrown exception `e`, reject `promise` with " +
    ...
    describe("3.3.3.3: If `then` is a function, call it with `x` as `this`, first argument `resolvePromise`, and " +
        ...
        describe("3.3.3.3.1: If/when `resolvePromise` is called with value `y`", function () {
            specify("3.3.3.1.1: If `x` and `y` refer to the same object, fulfill `promise` with `x`.", function (done) {
                var x = {
                    then: function (resolvePromise) {
                        resolvePromise(x);
                    }
            ...
            describe("3.3.3.1.2: Otherwise, run `[[Resolve]](promise, y)`.", function () {
        ...
        describe("3.3.3.3.2: If/when `rejectPromise` is called with reason `r`, reject `promise` with `r`",
                 function () {
            Object.keys(reasons).forEach(function (stringRepresentation) {
        ...
        describe("3.3.3.3.3: If both `resolvePromise` and `rejectPromise` are called, or multiple calls to the same " +
        ...
        describe("3.3.3.3.4: If calling `then` throws an exception `e`,", function () {
            describe("3.3.3.3.4.1: If `resolvePromise` or `rejectPromise` have been called, ignore it.", function () {
            ...
            describe("3.3.3.3.4.2: Otherwise, reject `promise` with `e` as the reason.", function () {
    ...
    describe("3.3.3.4: If `then` is not a function, fulfill promise with `x`", function () {
