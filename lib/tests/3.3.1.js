...
describe("3.3.1: If `x` is a promise, adopt its state", function () {
    describe("3.3.1.1: If `x` is pending, `promise` must remain pending until `x` is fulfilled or rejected.",
             function () {
        function xFactory() {
    ...
    describe("3.3.1.2: If/when `x` is fulfilled, fulfill `promise` with the same value.", function () {
    ...
    describe("3.3.1.3: If/when `x` is rejected, reject `promise` with the same reason.", function () {
