...
describe("3.2.6: `then` may be called multiple times on the same promise.", function () {
    describe("3.2.6.1: If/when `promise` is fulfilled, all respective `onFulfilled` callbacks must execute in the " +
    ...
    describe("3.2.6.2: If/when `promise` is rejected, all respective `onRejected` callbacks must execute in the " +
             "order of their originating calls to `then`.", function () {
