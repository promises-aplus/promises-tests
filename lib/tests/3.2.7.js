...
describe("3.2.7: `then` must return a promise: `promise2 = promise1.then(onFulfilled, onRejected)`", function () {
    ...
    describe("3.2.7.1: If either `onFulfilled` or `onRejected` returns a value that is not a thenable, `promise2` " +
    ...
    describe("3.2.7.2: If either `onFulfilled` or `onRejected` throws an exception, `promise2` " +
    ...
    describe("3.2.7.3: If either `onFulfilled` or `onRejected` returns a thenable (call it `returnedThenable`), run " +
             "the Thenable Assimilation Procedure `Assimilate(promise2, returnedThenable)`.", function () {

/*        describe("3.2.7.3.1: If `returnedPromise` is pending, `promise2` must remain pending until `returnedPromise` " +
        ...
        describe("3.2.7.3.2: If/when `returnedPromise` is fulfilled, `promise2` must be fulfilled with the same value.",
                 function () {
        ...
        describe("3.2.7.3.3: If/when `returnedPromise` is rejected, `promise2` must be rejected with the same reason.",
                 function () {
            describe("`promise1` is fulfilled, and `returnedPromise` is:", function () {
    ...
    describe("3.2.7.4: If `onFulfilled` is not a function and `promise1` is fulfilled, `promise2` must be fulfilled " +
    ...
    describe("3.2.7.5: If `onRejected` is not a function and `promise1` is rejected, `promise2` must be rejected " +
