...
describe("Returning a promise from a fulfilled promise's fulfillment callback", function () {
...
describe("Returning a promise from a rejected promise's rejection callback", function () {
    describe("when the returned promise is fulfilled", function () {
        it("should call the second fulfillment callback with the value", function (done) {
...
describe("Returning a promise from an eventually-fulfilled promise's fulfillment callback", function () {
...
describe("Returning a promise from an eventually-rejected promise's rejection callback", function () {
    describe("when the returned promise is eventually-fulfilled", function () {
        it("should call the second fulfillment callback with the value", function (done) {
            var tuple = pending();
