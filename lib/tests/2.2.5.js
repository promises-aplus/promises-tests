...
describe("2.2.5: `then` may be called any number of times.", function () {
    ...
    describe("2.2.5.1: `onFulfilled` and `onRejected` supplied in one call to then must never be called after those " +
             "supplied to a later call to then on the same promise.", function () {
        testFulfilled(dummy, function (promise, done) {
