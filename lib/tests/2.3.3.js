...
describe("2.3.3 smoke tests:", function () {
    specify("throw after fulfiling with a promise", function (done) {
        var fakePromise = {
            then: function (resolvePromise) {
                resolvePromise(resolved(sentinel));
                throw other;
            }
        };
        ...
        promise.then(function (value) {
            ...
            process.nextTick(function () {
                if (e === other) {
                    assert.fail("rejected promise", "resolved promise", "should have resolved");
                }
                throw e;
            });
        });
